...
/**
 * A single message bubble in a chat-style content view. Used by both
 * conversation (AI) and iMessage streams. User → right, accent. Assistant
 * → left, bg-sunken. Tool → left, monospaced, tinted orange.
 */
