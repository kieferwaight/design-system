...
export const oklchGenerativeScales: OklchGenerativeScales = {
  ...
  neutral: [
    { rung: 0, lightness: 0.99, chroma: 0.003, hueShift: -2 },
    { rung: 50, lightness: 0.97, chroma: 0.004, hueShift: -2 },
    { rung: 100, lightness: 0.94, chroma: 0.005, hueShift: -1 },
    { rung: 200, lightness: 0.89, chroma: 0.006, hueShift: -1 },
    { rung: 300, lightness: 0.81, chroma: 0.007, hueShift: 0 },
    { rung: 400, lightness: 0.71, chroma: 0.008, hueShift: 0 },
    { rung: 500, lightness: 0.60, chroma: 0.009, hueShift: 0 },

    // Midpoint / maximum coolness
    { rung: 600, lightness: 0.50, chroma: 0.008, hueShift: 1 },
    { rung: 700, lightness: 0.41, chroma: 0.007, hueShift: 2 },

    // Dark surfaces should become more neutral
    { rung: 800, lightness: 0.31, chroma: 0.006, hueShift: 3 },
    { rung: 900, lightness: 0.22, chroma: 0.004, hueShift: 4 },
    { rung: 1000, lightness: 0.15, chroma: 0.003, hueShift: 5 },
    { rung: 1100, lightness: 0.10, chroma: 0.002, hueShift: 6 },
  ],
  accent: [
    { rung: 50, lightness: 0.96, chroma: "calc(var(--seed-accent-c) * 0.18)", hueShift: -6 },
    { rung: 100, lightness: 0.92, chroma: "calc(var(--seed-accent-c) * 0.32)", hueShift: -4 },
    { rung: 200, lightness: 0.86, chroma: "calc(var(--seed-accent-c) * 0.52)", hueShift: -3 },
    { rung: 300, lightness: 0.78, chroma: "calc(var(--seed-accent-c) * 0.75)", hueShift: -2 },
    { rung: 400, lightness: 0.69, chroma: "calc(var(--seed-accent-c) * 0.95)", hueShift: 0 },
    { rung: 500, lightness: 0.61, chroma: "calc(var(--seed-accent-c) * 1.00)", hueShift: 0 },
    { rung: 600, lightness: 0.54, chroma: "calc(var(--seed-accent-c) * 1.08)", hueShift: 2 },
    { rung: 700, lightness: 0.47, chroma: "calc(var(--seed-accent-c) * 0.95)", hueShift: 4 },
    { rung: 800, lightness: 0.39, chroma: "calc(var(--seed-accent-c) * 0.72)", hueShift: 5 },
    { rung: 900, lightness: 0.31, chroma: "calc(var(--seed-accent-c) * 0.50)", hueShift: 6 },
    { rung: 950, lightness: 0.24, chroma: "calc(var(--seed-accent-c) * 0.34)", hueShift: 8 },
  ],
  status: {
